...
namespace DesafioTeylor.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Edition(string name, DateTime birthdate, string cpf, string address, string city, int id, string edit)
        {
            if (edit == "Editar")
            {
